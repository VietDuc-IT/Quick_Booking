...
export default function RefreshPass() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!formData.password || !formData.rePassword) {
            setMessage(null);
            return setErrorMessage('Bạn cần điền đủ thông tin.');
        }
        if (formData.password.length < 6) {
            setMessage(null);
            return setErrorMessage('Mật khẩu phải có ít nhất 6 kí tự.');
        }
        if (formData.password !== formData.rePassword) {
            setMessage(null);
            return setErrorMessage('Xác nhận mật khẩu không trùng khớp.');
        }
        setLoading(true);
        try {
                    ...
                    <div className="w-full  dark:dark xl:w-1/2 xl:border-l-2">
                        <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                {message && (
                                    <Alert className="my-3" color="info">
                                        {message}
                                    </Alert>
                                )}
                                ...
                                <button
                                    type="submit"
                                    disabled={loading}
                                    className="w-full cursor-pointer rounded-lg border  bg-green-500 p-4 text-white transition hover:bg-opacity-90 mb-5 mt-7"
                                >
                                    {loading ? (
                                        <>
                                            <Spinner size="sm" />
