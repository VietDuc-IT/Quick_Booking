...
export default function SignIn() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            // API
            const res = await httpRequest.post(`/auth/login`, formData, { withCredentials: true });
    ...
    return (
        <section className="">
            <div className="px-5 rounded-sm border  bg-white shadow-default dark:dark dark:bg-boxdark">
                        ...
                        <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="mb-4">
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            className="w-full rounded-lg border  bg-transparent py-4 pl-6 pr-10 outline-none focus: focus-visible:shadow-none dark:border-form-green-500dark dark:bg-form-input dark:focus:"
                                        />
                                ...
                                <button
                                    type="submit"
                                    disabled={loading}
                                    className="w-full cursor-pointer rounded-lg border  bg-green-500 p-4 text-white transition hover:bg-opacity-90 mb-5"
                                >
                                    {loading ? (
                                        <>
                                            <Spinner size="sm" />
                                ...
                                <button className="flex w-full items-center justify-center gap-3.5 rounded-lg border  bg-gray p-4 hover:bg-opacity-50 dark:dark dark:bg-meta-4 dark:hover:bg-opacity-50">
                                    <span>
                                        <svg
                                            width="20"
                                            height="20"
