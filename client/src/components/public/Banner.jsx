...
const Banner = () => {
    return (
        <>
            <div className="lg:px-14 max-w-screen-2xl mx-auto">
                    ...
                    <div className="m-auto">
                        <div>
                            ...
                            <p className="text-neutralGrey text-base mb-8">
                                QuickBooking là nơi người cho thuê dễ dàng đăng tải những tin rao nhà thuê một cách dễ
                                dàng với đầy đủ thông tin với giá cả và liên hệ rõ ràng. Từ đó sẽ giúp người tìm nhà
                                thuê dễ dàng tìm kiếm và lựa chọn cho mình những căn nhà thuê ưng ý, phù hợp nhu cầu sử
                                dụng với mức giá tốt.
                            </p>
                            <Link to="/postnew">
